...
all: clean
	g++ -std=c++1y -o main main.cpp Resize.cpp Erosion.cpp Lighten.cpp Darken.cpp Panaroma.cpp Dilation.cpp Help_description.cpp `pkg-config --cflags --libs opencv` -I.
